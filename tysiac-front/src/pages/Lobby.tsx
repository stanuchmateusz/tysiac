            ...
            <div className="flex flex-col flex-1 max-w-6xl mx-auto gap-4 md:gap-6">
                <div className="flex flex-col md:flex-row items-center justify-between mb-4 md:mb-6 gap-2 md:gap-0">
                    ...
                    <div className="flex flex-wrap items-center space-x-2 md:space-x-4 w-full md:w-auto justify-end">
                        ...
                        <button onClick={() => setShowCode(!showCode)} className="cursor-pointer px-2 py-1 bg-gradient-to-r from-gray-600 to-gray-800 rounded text-white hover:from-gray-700 hover:to-gray-900">
                            {showCode ? <GrHide /> : <GrView />}
                        </button>
                        <button onClick={async () => await navigator.clipboard.writeText(gameCode)} className="cursor-pointer p-2 bg-gradient-to-r from-blue-500 to-blue-700 rounded text-white hover:from-blue-600 hover:to-blue-800">
